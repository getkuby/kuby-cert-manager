      ...
      module CertManager
        module V1
          class IssuerSpecVault < ::KubeDSL::DSLObject
            ...
            object_field(:auth) { Kuby::CertManager::DSL::CertManager::V1::IssuerSpecVaultAuth.new }
            value_field :server
            ...
            validates :auth, object: { kind_of: Kuby::CertManager::DSL::CertManager::V1::IssuerSpecVaultAuth }
