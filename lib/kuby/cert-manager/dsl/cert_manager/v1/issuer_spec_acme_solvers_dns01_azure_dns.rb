      ...
      module CertManager
        module V1
          class IssuerSpecAcmeSolversDns01AzureDNS < ::KubeDSL::DSLObject
            object_field(:client_secret_secret_ref) { Kuby::CertManager::DSL::CertManager::V1::IssuerSpecAcmeSolversDns01AzureDNSClientSecretSecretRef.new }
            ...
            object_field(:managed_identity) { Kuby::CertManager::DSL::CertManager::V1::IssuerSpecAcmeSolversDns01AzureDNSManagedIdentity.new }
            value_field :subscription_id

            validates :client_secret_secret_ref, object: { kind_of: Kuby::CertManager::DSL::CertManager::V1::IssuerSpecAcmeSolversDns01AzureDNSClientSecretSecretRef }
            ...
            validates :managed_identity, object: { kind_of: Kuby::CertManager::DSL::CertManager::V1::IssuerSpecAcmeSolversDns01AzureDNSManagedIdentity }
            ...
            def kind_sym
              :issuer_spec_acme_solvers_dns01_azure_dns
            end
          end
        end
      end
