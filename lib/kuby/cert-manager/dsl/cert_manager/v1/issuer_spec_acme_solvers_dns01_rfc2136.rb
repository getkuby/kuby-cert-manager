      ...
      module CertManager
        module V1
          class IssuerSpecAcmeSolversDns01Rfc2136 < ::KubeDSL::DSLObject
            object_field(:tsig_secret_secret_ref) { Kuby::CertManager::DSL::CertManager::V1::IssuerSpecAcmeSolversDns01Rfc2136TsigSecretSecretRef.new }
            value_field :nameserver
            value_field :tsig_key_name
            value_field :tsig_algorithm

            validates :tsig_secret_secret_ref, object: { kind_of: Kuby::CertManager::DSL::CertManager::V1::IssuerSpecAcmeSolversDns01Rfc2136TsigSecretSecretRef }
            ...
            def kind_sym
              :issuer_spec_acme_solvers_dns01_rfc2136
            end
          end
        end
      end
