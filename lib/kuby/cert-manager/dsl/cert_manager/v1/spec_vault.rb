      ...
      module CertManager
        module V1
          class SpecVault < ::KubeDSL::DSLObject
            ...
            object_field(:auth) { Kuby::CertManager::DSL::CertManager::V1::SpecVaultAuth.new }
            value_field :server
            ...
            validates :auth, object: { kind_of: Kuby::CertManager::DSL::CertManager::V1::SpecVaultAuth }
