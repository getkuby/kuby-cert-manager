      ...
      module CertManager
        module V1
          class ClusterIssuerSpecAcmeSolversDns01Route53 < ::KubeDSL::DSLObject
            ...
            value_field :region
            value_field :role
            object_field(:secret_access_key_secret_ref) { Kuby::CertManager::DSL::CertManager::V1::ClusterIssuerSpecAcmeSolversDns01Route53SecretAccessKeySecretRef.new }
            ...
            validates :secret_access_key_secret_ref, object: { kind_of: Kuby::CertManager::DSL::CertManager::V1::ClusterIssuerSpecAcmeSolversDns01Route53SecretAccessKeySecretRef }
            ...
            def kind_sym
              :cluster_issuer_spec_acme_solvers_dns01_route53
            end
          end
        end
      end
