      ...
      module CertManager
        module V1
          class IssuerSpecAcme < ::KubeDSL::DSLObject
            ...
            object_field(:external_account_binding) { Kuby::CertManager::DSL::CertManager::V1::IssuerSpecAcmeExternalAccountBinding.new }
            array_field(:solver) { Kuby::CertManager::DSL::CertManager::V1::IssuerSpecAcmeSolvers.new }
            object_field(:private_key_secret_ref) { Kuby::CertManager::DSL::CertManager::V1::IssuerSpecAcmePrivateKeySecretRef.new }
            ...
            validates :external_account_binding, object: { kind_of: Kuby::CertManager::DSL::CertManager::V1::IssuerSpecAcmeExternalAccountBinding }
            validates :solvers, array: { kind_of: Kuby::CertManager::DSL::CertManager::V1::IssuerSpecAcmeSolvers }, presence: false
            validates :private_key_secret_ref, object: { kind_of: Kuby::CertManager::DSL::CertManager::V1::IssuerSpecAcmePrivateKeySecretRef }
