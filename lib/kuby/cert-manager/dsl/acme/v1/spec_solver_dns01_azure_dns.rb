      ...
      module Acme
        module V1
          class SpecSolverDns01AzureDNS < ::KubeDSL::DSLObject
            object_field(:client_secret_secret_ref) { Kuby::CertManager::DSL::Acme::V1::SpecSolverDns01AzureDNSClientSecretSecretRef.new }
            ...
            object_field(:managed_identity) { Kuby::CertManager::DSL::Acme::V1::SpecSolverDns01AzureDNSManagedIdentity.new }
            value_field :subscription_id

            validates :client_secret_secret_ref, object: { kind_of: Kuby::CertManager::DSL::Acme::V1::SpecSolverDns01AzureDNSClientSecretSecretRef }
            ...
            validates :managed_identity, object: { kind_of: Kuby::CertManager::DSL::Acme::V1::SpecSolverDns01AzureDNSManagedIdentity }
