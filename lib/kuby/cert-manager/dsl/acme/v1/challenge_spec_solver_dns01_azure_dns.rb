      ...
      module Acme
        module V1
          class ChallengeSpecSolverDns01AzureDNS < ::KubeDSL::DSLObject
            object_field(:client_secret_secret_ref) { Kuby::CertManager::DSL::Acme::V1::ChallengeSpecSolverDns01AzureDNSClientSecretSecretRef.new }
            ...
            object_field(:managed_identity) { Kuby::CertManager::DSL::Acme::V1::ChallengeSpecSolverDns01AzureDNSManagedIdentity.new }
            value_field :subscription_id

            validates :client_secret_secret_ref, object: { kind_of: Kuby::CertManager::DSL::Acme::V1::ChallengeSpecSolverDns01AzureDNSClientSecretSecretRef }
            ...
            validates :managed_identity, object: { kind_of: Kuby::CertManager::DSL::Acme::V1::ChallengeSpecSolverDns01AzureDNSManagedIdentity }
            ...
            def kind_sym
              :challenge_spec_solver_dns01_azure_dns
            end
          end
        end
      end
