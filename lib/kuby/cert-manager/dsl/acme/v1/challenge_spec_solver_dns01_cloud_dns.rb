      ...
      module Acme
        module V1
          class ChallengeSpecSolverDns01CloudDNS < ::KubeDSL::DSLObject
            ...
            value_field :project
            object_field(:service_account_secret_ref) { Kuby::CertManager::DSL::Acme::V1::ChallengeSpecSolverDns01CloudDNSServiceAccountSecretRef.new }

            validates :hosted_zone_name, field: { format: :string }, presence: false
            validates :project, field: { format: :string }, presence: true
            validates :service_account_secret_ref, object: { kind_of: Kuby::CertManager::DSL::Acme::V1::ChallengeSpecSolverDns01CloudDNSServiceAccountSecretRef }
