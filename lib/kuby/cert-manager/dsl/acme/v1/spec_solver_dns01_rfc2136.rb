      ...
      module Acme
        module V1
          class SpecSolverDns01Rfc2136 < ::KubeDSL::DSLObject
            object_field(:tsig_secret_secret_ref) { Kuby::CertManager::DSL::Acme::V1::SpecSolverDns01Rfc2136TsigSecretSecretRef.new }
            value_field :nameserver
            value_field :tsig_key_name
            value_field :tsig_algorithm

            validates :tsig_secret_secret_ref, object: { kind_of: Kuby::CertManager::DSL::Acme::V1::SpecSolverDns01Rfc2136TsigSecretSecretRef }
