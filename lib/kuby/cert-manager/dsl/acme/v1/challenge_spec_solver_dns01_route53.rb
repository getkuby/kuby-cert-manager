      ...
      module Acme
        module V1
          class ChallengeSpecSolverDns01Route53 < ::KubeDSL::DSLObject
            ...
            value_field :region
            value_field :role
            object_field(:secret_access_key_secret_ref) { Kuby::CertManager::DSL::Acme::V1::ChallengeSpecSolverDns01Route53SecretAccessKeySecretRef.new }
            ...
            validates :secret_access_key_secret_ref, object: { kind_of: Kuby::CertManager::DSL::Acme::V1::ChallengeSpecSolverDns01Route53SecretAccessKeySecretRef }
            ...
            def kind_sym
              :challenge_spec_solver_dns01_route53
            end
          end
        end
      end
