          ...
          class CertificateRequestList < ::KubeDSL::DSLObject
            ...
            T::Sig::WithoutRuntime.sig {
              params(
                ...
                block: T.nilable(T.proc.returns(Kuby::CertManager::DSL::CertManager::V1::CertificateRequest))
              ).returns(T::Array[Kuby::CertManager::DSL::CertManager::V1::CertificateRequest])
            }
